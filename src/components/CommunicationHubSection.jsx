...
export function CommunicationHubGraphic({ isVisible = true }) {
...
export function CommunicationHubText({ isVisible = true }) {
  return (
...
// Keep the original export for backward compatibility or mobile views
  ...
  return (
    <section className={styles.section} ref={sectionRef}>
      <div className={styles.container}>
        <CommunicationHubGraphic isVisible={isVisible} />
        <CommunicationHubText isVisible={isVisible} />
      </div>
    </section>
  );
}
